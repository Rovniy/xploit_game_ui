...
Статус: Этапы 0–8 завершены (native 265/265, Unity PlayMode 46/46 на D3D12), то есть MVP из ТЗ собран. Этап 9 (UI в мировом пространстве) пропущен по решению заказчика. Следующий — Этап 10: оптимизация. См. [docs/PLAN.md](docs/PLAN.md).
